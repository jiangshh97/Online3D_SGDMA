...
#include <memory>
#include "../../../src/ui/imageviewerwidget.h"
...
QT_MOC_LITERAL(1, 18, 22), // "sendImageViewerMessage"
QT_MOC_LITERAL(2, 41, 0), // ""
QT_MOC_LITERAL(3, 42, 6), // "module"
QT_MOC_LITERAL(4, 49, 3), // "msg"
QT_MOC_LITERAL(5, 53, 4) // "code"

    },
    "ImageViewerWidget\0sendImageViewerMessage\0"
    "\0module\0msg\0code"
};
...
void ImageViewerWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendImageViewerMessage((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ImageViewerWidget::*)(QString , QString , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ImageViewerWidget::sendImageViewerMessage)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject ImageViewerWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_ImageViewerWidget.data,
    qt_meta_data_ImageViewerWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void ImageViewerWidget::sendImageViewerMessage(QString _t1, QString _t2, int _t3)
{
