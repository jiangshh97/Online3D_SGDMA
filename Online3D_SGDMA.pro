...
# Mian
INCLUDEPATH += $$PWD/src/
include     ($$PWD/src/zMain.pri)
# log
INCLUDEPATH += $$PWD/src/config
include     ($$PWD/src/config/config.pri)
# log
INCLUDEPATH += $$PWD/src/logging
include     ($$PWD/src/logging/logging.pri)
# reconstruction
INCLUDEPATH += $$PWD/src/reconstructionProcess
include     ($$PWD/src/reconstructionProcess/reconstructionProcess.pri)
# YOLO
INCLUDEPATH += $$PWD/src/yolo
include     ($$PWD/src/yolo/yolo.pri)
...
#OpenCV
INCLUDEPATH += D:/apps/opencv4.4.0/include
INCLUDEPATH += D:/apps/opencv4.4.0/include/opencv2
CONFIG(debug,debug|release){
LIBS += -LD:/apps/opencv4.4.0/x64/vc15/lib \
        -lopencv_world440d
}
else{
LIBS += -LD:/apps/opencv4.4.0/x64/vc15/lib \
...
LIBS += -L'C:/Program Files/NVIDIA GPU Computing Toolkit/CUDA/v11.7/lib/x64' \
        -lcublas \
        -lcublasLt \
        -lcuda \
        -lcudadevrt \
...
#TensorRT
INCLUDEPATH += D:/apps/TensorRT-8.4.3.1/include
LIBS += -LD:/apps/TensorRT-8.4.3.1/lib \
        -lnvinfer \
        -lnvinfer_plugin \
        -lnvonnxparser \
        -lnvparsers
